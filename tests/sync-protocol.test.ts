...
describe('Orchestrator: Sync Protocol Enforcement Validation', () => {
  it('should validate and parse a securely formed and correct manifest', () => {
    const valid = {
  ...
  it('should securely reject manifests with unsafe asset configurations (e.g., bad SHA-256 lengths)', () => {
    const invalidAsset = {
    ...
    expect(() => validateManifest(invalidAsset)).toThrowError(/Strict SHA-256 string validation required/);
  });
