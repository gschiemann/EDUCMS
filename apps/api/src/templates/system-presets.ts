  ...
  },
{
    ...
    description: 'Cork-board cafeteria menu — pinned plate polaroid, index-card menu items, chef’s memo card. · Vertical 4K layout',
  ...
  },
{
    ...
    description: 'Cork-board hallway layout — pinned index cards, washi tape corners, schedule rows, attendance pin. · Vertical 4K layout',
  ...
  },
{
    ...
    description: 'Neon-sunset café menu board — steaming coffee cup logo, weekly menu, trophy + yearbook accents, allergen ticker. · Vertical 4K layout',
  ...
  },
{
    ...
    description: 'Varsity / stadium-styled cafeteria menu board — pennants, scoreboard, weekly menu, chef polaroid, birthdays, allergen ticker. · Vertical 4K layout',
  ...
  },
{
    ...
    description: 'Green-chalkboard menu board — chalk-textured text, erased highlights, wooden frame, weekly menu editor. · Vertical 4K layout',
  ...
  },
{
    ...
    description: 'Newsroom lower-thirds lobby: ON AIR indicator, lower-third headline, forecast panel, featured guest of the week, breaking-story card, bottom crawl ticker. · Vertical 4K layout',
    category: 'LOBBY_WELCOME', orientation: 'PORTRAIT', schoolLevel: 'HIGH',
  ...
  },
{
    ...
    description: 'CRT monitor lobby: phosphor-green monospace, scanlines, whoami teacher card, cron events log, /var/log/syslog ticker, VT323 banner with blinking cursor. · Vertical 4K layout',
    category: 'LOBBY_WELCOME', orientation: 'PORTRAIT', schoolLevel: 'HIGH',
  ...
  },
{
    ...
    description: 'Departure-board lobby: amber split-flap rows, classes as "flights" with room-gate + teacher + colored status chips, advisory card, flight-crew teacher spotlight, PA ticker. · Vertical 4K layout',
    category: 'LOBBY_WELCOME', orientation: 'PORTRAIT', schoolLevel: 'HIGH',
  ...
  },
{
    ...
    description: 'Magazine-spread lobby: serif masthead, drop-cap italic lede, photo feature with caption, featured portrait pull-quote, calendar folio footer, wire ticker. · Vertical 4K layout',
    category: 'LOBBY_WELCOME', orientation: 'PORTRAIT', schoolLevel: 'HIGH',
  ...
  },
{
    ...
    description: 'DIY student-zine lobby: rotated taped panels, photocopied paper texture, marker-style headlines with yellow highlight, polaroid events, ransom-letter announcement, xeroxwire ticker. · Vertical 4K layout',
    category: 'LOBBY_WELCOME', orientation: 'PORTRAIT', schoolLevel: 'HIGH',
  ...
  },
{
    ...
    description: 'Scrapbook cafeteria menu — polaroid plate, washi-tape menu cards, handwritten allergen notes. · Vertical 4K layout',
    category: 'CAFETERIA', orientation: 'PORTRAIT', schoolLevel: 'ELEMENTARY',
  ...
  },
{
    ...
    description: 'Scrapbook hallway board — polaroids, washi tape, handwritten fonts, attendance, announcements, ticker. · Vertical 4K layout',
    category: 'HALLWAY', orientation: 'PORTRAIT', schoolLevel: 'ELEMENTARY',
    screenWidth: 2160, screenHeight: 3840, bgColor: '#fff7ed',
    zones: [{ name: 'Scene', widgetType: 'SCRAPBOOK_HALLWAY', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: {} }],
  },
{
    ...
    description: 'Open-book cafeteria menu — parchment pages, illuminated drop cap, chef’s note, multi-period countdown. · Vertical 4K layout',
    category: 'CAFETERIA', orientation: 'PORTRAIT', schoolLevel: 'ELEMENTARY',
  ...
  },
{
    ...
    description: 'Open-book hallway layout — center spine, illuminated drop cap, parchment pages, schedule + attendance, page numbers. · Vertical 4K layout',
    category: 'HALLWAY', orientation: 'PORTRAIT', schoolLevel: 'ELEMENTARY',
    screenWidth: 2160, screenHeight: 3840, bgColor: '#f5f0dc',
    zones: [{ name: 'Scene', widgetType: 'STORYBOOK_HALLWAY', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: {} }],
  },
  {
    ...
    description: 'Full-screen ANIMATED middle-school welcome — stadium spotlights, pennant bunting, scoreboard clock, varsity teacher, megaphone announcement, stopwatch countdown, layered birthdays cake, LED ticker. · Vertical 4K layout',
    category: 'LOBBY', orientation: 'PORTRAIT', schoolLevel: 'MIDDLE',
    screenWidth: 2160, screenHeight: 3840, bgColor: '#0f172a',
    bgGradient: 'linear-gradient(135deg,#0f172a 0%,#1e3a8a 50%,#0f172a 100%)',
    zones: [{ name: 'Animated Welcome Scene (Middle School)', widgetType: 'ANIMATED_WELCOME_MS', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: {} }],
  },
  {
