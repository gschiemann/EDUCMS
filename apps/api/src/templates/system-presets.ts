  ...
  },
{
  ...
  },
  {
    ...
    category: 'FASHION', orientation: 'LANDSCAPE',
    screenWidth: 3840, screenHeight: 2160, bgColor: '#0f172a',
  ...
  // church / veterinary / gym / real-estate / museum / office / clinic. Each a
  ...
  { id: 'preset-sig-church-01', name: "Church · Welcome", description: "Welcome / verse + service times — 3840×2160 worship signage.", category: 'WORSHIP', orientation: 'LANDSCAPE', screenWidth: 3840, screenHeight: 2160, bgColor: '#0b0e1e', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/signage/church/01-welcome-flagship.html' } }] },
  { id: 'preset-sig-church-02', name: "Church · Welcome (Light)", description: "Welcome / verse — warm/light theme — 3840×2160 worship signage.", category: 'WORSHIP', orientation: 'LANDSCAPE', screenWidth: 3840, screenHeight: 2160, bgColor: '#f4ecdd', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/signage/church/01-welcome-light.html' } }] },
  { id: 'preset-sig-church-03', name: "Church · Series", description: "Sermon-series full-bleed art — 3840×2160 worship signage.", category: 'WORSHIP', orientation: 'LANDSCAPE', screenWidth: 3840, screenHeight: 2160, bgColor: '#0a0d14', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/signage/church/02-series.html' } }] },
  { id: 'preset-sig-church-04', name: "Church · Series (Light)", description: "Sermon-series art — warm/light theme — 3840×2160 worship signage.", category: 'WORSHIP', orientation: 'LANDSCAPE', screenWidth: 3840, screenHeight: 2160, bgColor: '#f4ecdd', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/signage/church/02-series-light.html' } }] },
  { id: 'preset-sig-church-05', name: "Church · This Week", description: "This-week ministries + events — 3840×2160 worship signage.", category: 'WORSHIP', orientation: 'LANDSCAPE', screenWidth: 3840, screenHeight: 2160, bgColor: '#0c0f1f', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/signage/church/03-this-week.html' } }] },
  { id: 'preset-sig-church-06', name: "Church · This Week (Light)", description: "This-week ministries — warm/light theme — 3840×2160 worship signage.", category: 'WORSHIP', orientation: 'LANDSCAPE', screenWidth: 3840, screenHeight: 2160, bgColor: '#f4ecdd', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/signage/church/03-this-week-light.html' } }] },
  { id: 'preset-sig-church-07', name: "Church · Next Steps & Give", description: "Next-steps + giving/tithe — 3840×2160 worship signage.", category: 'WORSHIP', orientation: 'LANDSCAPE', screenWidth: 3840, screenHeight: 2160, bgColor: '#0b0e1e', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/signage/church/04-next-steps-give.html' } }] },
  { id: 'preset-sig-church-08', name: "Church · Next Steps & Give (Light)", description: "Next-steps + giving — warm/light theme — 3840×2160 worship signage.", category: 'WORSHIP', orientation: 'LANDSCAPE', screenWidth: 3840, screenHeight: 2160, bgColor: '#f4ecdd', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/signage/church/04-next-steps-give-light.html' } }] },
  { id: 'preset-sig-church-09', name: "Church · Prayer Wall", description: "Votive prayer wall — 3840×2160 worship signage.", category: 'WORSHIP', orientation: 'LANDSCAPE', screenWidth: 3840, screenHeight: 2160, bgColor: '#0a0d1c', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/signage/church/05-prayer-wall.html' } }] },
  { id: 'preset-sig-church-10', name: "Church · Prayer Wall (Light)", description: "Votive prayer wall — warm/light theme — 3840×2160 worship signage.", category: 'WORSHIP', orientation: 'LANDSCAPE', screenWidth: 3840, screenHeight: 2160, bgColor: '#f4ecdd', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/signage/church/05-prayer-wall-light.html' } }] },
