...
const RAW_SYSTEM_PRESETS: SystemPreset[] = [
  ...
  // presets still use the React portrait widgets (left as-is).
  {
    ...
    name: '🔔 Bell Schedule — Pulse Rail',
    description: 'Living bell board — the current period, next-bell countdown and progress bar resolve against the time zone configured on the board, so the highlighted row is always correct. Every period row, room, name and time is operator-editable and the live states follow what you type. Authored portrait composition.',
    category: 'HALLWAY', orientation: 'LANDSCAPE', schoolLevel: 'HIGH',
  ...
  },
  {
    ...
    name: '📺 Morning News — Headline Split',
    description: 'Student-news broadcast board — real campus video hero with poster fallback, top story with byline facts, coming-up rail, live/manual clock, fully replaceable video/poster/logo/background, playback and crop controls, full brand styling, and an authored portrait composition.',
    category: 'LOBBY', orientation: 'LANDSCAPE', schoolLevel: 'UNIVERSAL',
    screenWidth: 3840, screenHeight: 2160, bgColor: '#071821',
  ...
  {
    id: 'preset-hs-news-rundown-desk',
    name: '🗞️ Morning News — Rundown Desk',
    description: 'Student-news broadcast board — big campus video lead with headline card and a dark rundown column of the day\'s updates, ticker footer, live/manual clock, fully replaceable video/poster/logo/background, playback and crop controls, full brand styling, and an authored portrait composition.',
    category: 'LOBBY', orientation: 'LANDSCAPE', schoolLevel: 'UNIVERSAL',
    screenWidth: 3840, screenHeight: 2160, bgColor: '#eef2ef',
    zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/hs/morning-news-rundown-desk.html' } }],
  },
  {
    id: 'preset-hs-news-daily-cut',
    name: '🎬 Morning News — Daily Cut',
    description: 'Student-news broadcast board — full-width campus video band over a headline and three quick briefs, ticker footer, live/manual clock, fully replaceable video/poster/logo/background, playback and crop controls, full brand styling, and an authored portrait composition.',
    category: 'LOBBY', orientation: 'LANDSCAPE', schoolLevel: 'UNIVERSAL',
    screenWidth: 3840, screenHeight: 2160, bgColor: '#f4f0e6',
    zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/hs/morning-news-daily-cut.html' } }],
  },
  {
    id: 'preset-achievement-showcase',
    name: '🏆 Achievement Showcase — Honor Cover',
    description: 'Achievement showcase — student-of-the-week feature photo, honor roll and stat callouts, all editable, with an authored portrait composition.',
    category: 'LOBBY', orientation: 'LANDSCAPE', schoolLevel: 'HIGH',
    screenWidth: 3840, screenHeight: 2160, bgColor: '#f5f0e6',
  ...
  },
{
    ...
    name: '🏆 Achievement Showcase — Honor Cover — Portrait',
    description: 'Achievement showcase built FOR portrait — the Honor Cover feature in its separately authored 1080x1920 composition. Same editable photo, honor roll and stats. Real vertical layout, not letterboxed. · 4K portrait',
    category: 'LOBBY', orientation: 'PORTRAIT', schoolLevel: 'HIGH',
    screenWidth: 2160, screenHeight: 3840, bgColor: '#f5f0e6',
    zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/hs/achievement.html?o=portrait' } }],
  },
{
    id: 'preset-bell-schedule-portrait',
    name: '🔔 Bell Schedule — Pulse Rail — Portrait',
    description: 'Living bell board built FOR portrait — the Pulse Rail schedule in its separately authored 1080x1920 composition. Same time-zone-aware current period, countdown and full editability. Real vertical layout, not letterboxed. · 4K portrait',
    category: 'HALLWAY', orientation: 'PORTRAIT', schoolLevel: 'HIGH',
    screenWidth: 2160, screenHeight: 3840, bgColor: '#f5f1e8',
    zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/hs/bell-schedule.html?o=portrait' } }],
  },
{
  ...
  },
{
    ...
    name: '📺 Morning News — Headline Split — Portrait',
    description: 'Student-news broadcast board built FOR portrait — the Headline Split campus-video hero in its separately authored 1080×1920 composition. Same replaceable video/poster/logo/background, playback and crop controls, live/manual clock, and full editability. Real vertical layout, not letterboxed. · 4K portrait',
    category: 'LOBBY', orientation: 'PORTRAIT', schoolLevel: 'UNIVERSAL',
    screenWidth: 2160, screenHeight: 3840, bgColor: '#071821',
    zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/hs/morning-news.html?o=portrait' } }],
  },
{
  ...
  },
{
  ...
  },
  {
    ...
    category: 'CONFERENCE', orientation: 'LANDSCAPE',
    screenWidth: 3840, screenHeight: 2160, bgColor: '#0f172a',
  ...
  },
  {
    ...
    category: 'INTERNAL', orientation: 'LANDSCAPE',
    screenWidth: 3840, screenHeight: 2160, bgColor: '#0f172a',
  ...
  {
    id: 'preset-sig-qsr-25-super-taco-tacos',
    name: 'Super Taco · Menu Wall 1 · Tacos',
    description: 'Left screen of a coordinated three-screen Super Taco menu wall. Taco products, prices, descriptions and photos update from the mapped Toast location.',
    category: 'QSR', orientation: 'LANDSCAPE',
    screenWidth: 3840, screenHeight: 2160, bgColor: '#f7f0e3',
    zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/signage/qsr/25-super-taco-tacos.html', posSync: true, posProvider: 'toast', dataSource: 'POS' } }],
  },
  {
    id: 'preset-sig-qsr-26-super-taco-burritos',
    name: 'Super Taco · Menu Wall 2 · Burritos & More',
    description: 'Center screen of the Super Taco menu wall. Burritos, nachos, quesadillas and drinks update from the mapped Toast location.',
    category: 'QSR', orientation: 'LANDSCAPE',
    screenWidth: 3840, screenHeight: 2160, bgColor: '#f7f0e3',
    zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/signage/qsr/26-super-taco-burritos.html', posSync: true, posProvider: 'toast', dataSource: 'POS' } }],
  },
  {
    id: 'preset-sig-qsr-27-super-taco-combos',
    name: 'Super Taco · Menu Wall 3 · Combo Spotlight',
    description: 'Right screen of the Super Taco menu wall. Rotates combination plates; names, prices, descriptions and photos update from the mapped Toast location.',
    category: 'QSR', orientation: 'LANDSCAPE',
    screenWidth: 3840, screenHeight: 2160, bgColor: '#f7f0e3',
    zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/signage/qsr/27-super-taco-combos.html', posSync: true, posProvider: 'toast', dataSource: 'POS' } }],
  },
  {
    id: 'preset-sig-qsr-25-super-taco-tacos-portrait',
    name: 'Super Taco · Menu Wall 1 · Tacos · Portrait',
    description: 'Portrait version of the three-screen Super Taco menu wall. Taco menu update from Toast.',
    category: 'QSR', orientation: 'PORTRAIT',
    screenWidth: 2160, screenHeight: 3840, bgColor: '#f7f0e3',
    zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/signage/qsr/25-super-taco-tacos.html?orientation=portrait', posSync: true, posProvider: 'toast', dataSource: 'POS' } }],
  },
  {
    id: 'preset-sig-qsr-26-super-taco-burritos-portrait',
    name: 'Super Taco · Menu Wall 2 · Burritos & More · Portrait',
    description: 'Portrait version of the three-screen Super Taco menu wall. Burritos, nachos, quesadillas and drinks update from Toast.',
    category: 'QSR', orientation: 'PORTRAIT',
    screenWidth: 2160, screenHeight: 3840, bgColor: '#f7f0e3',
    zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/signage/qsr/26-super-taco-burritos.html?orientation=portrait', posSync: true, posProvider: 'toast', dataSource: 'POS' } }],
  },
  {
    id: 'preset-sig-qsr-27-super-taco-combos-portrait',
    name: 'Super Taco · Menu Wall 3 · Combo Spotlight · Portrait',
    description: 'Portrait version of the three-screen Super Taco menu wall. Rotating combination plates update from Toast.',
    category: 'QSR', orientation: 'PORTRAIT',
    screenWidth: 2160, screenHeight: 3840, bgColor: '#f7f0e3',
    zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/signage/qsr/27-super-taco-combos.html?orientation=portrait', posSync: true, posProvider: 'toast', dataSource: 'POS' } }],
  },
  {
...
const MODERN_SCHOOL_PRESETS: SystemPreset[] = [
  ...
  { id: 'preset-school-elem-lunch-1', name: "🍱 Today's Lunch — Confetti Pop 2.0", description: 'Flagship elementary lunch poster — one realistic school entrée, direct side/fruit/drink hierarchy, live time, editable photo and background, allergen details, and an authored portrait composition. No emoji food or lunch-tray imagery.', category: 'CAFETERIA', orientation: 'LANDSCAPE', schoolLevel: 'ELEMENTARY', screenWidth: 3840, screenHeight: 2160, bgColor: '#fff7e7', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/elem-lunch-v1.html' } }] },
  { id: 'preset-school-elem-lunch-2', name: "🍽️ Today's Lunch — Color Route", description: 'Elementary three-choice lunch board — color-coded route cards with real food photography, live time, editable photos/background/logo, full brand styling, allergen line, and an authored portrait composition. No emoji food.', category: 'CAFETERIA', orientation: 'LANDSCAPE', schoolLevel: 'ELEMENTARY', screenWidth: 3840, screenHeight: 2160, bgColor: '#102a43', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/elem-lunch-v2.html' } }] },
  { id: 'preset-school-elem-lunch-3', name: "📰 Today's Lunch — Lunch Edition", description: 'Elementary three-choice lunch board — newspaper-front-page layout with a lead entrée photo and two more choices, live time, editable photos/background/logo, full brand styling, allergen line, and an authored portrait composition.', category: 'CAFETERIA', orientation: 'LANDSCAPE', schoolLevel: 'ELEMENTARY', screenWidth: 3840, screenHeight: 2160, bgColor: '#f4eddd', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/elem-lunch-v3.html' } }] },
  { id: 'preset-school-elem-lunch-4', name: "🍽️ Today's Lunch — Service Ticket", description: 'Flagship elementary cafeteria service-ticket board with a realistic baked-ziti entrée, direct sides and alternate choice, live time, editable photo/background/logo, allergen details, and a dedicated portrait composition.', category: 'CAFETERIA', orientation: 'LANDSCAPE', schoolLevel: 'ELEMENTARY', screenWidth: 3840, screenHeight: 2160, bgColor: '#10264d', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/elem-lunch-v4-service-ticket.html' } }] },
  { id: 'preset-school-elem-lunch-5', name: "🥗 Today's Lunch — Fresh Counter", description: 'Flagship elementary fresh-counter board with a synchronized three-entrée carousel. Each real food image, entrée name, description, sides, alternate, allergen line, rotation timing, background, logo, and brand style is independently editable; portrait is separately composed.', category: 'CAFETERIA', orientation: 'LANDSCAPE', schoolLevel: 'ELEMENTARY', screenWidth: 3840, screenHeight: 2160, bgColor: '#f5f1e6', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/elem-lunch-v5-fresh-counter.html' } }] },
  { id: 'preset-school-elem-lunch-6', name: "🎬 Today's Lunch — Menu Lab", description: 'Flagship elementary video menu with a real muted 4K kitchen loop, editable video source and poster fallback, playback speed and loop controls, live time, editable background/logo/text, full brand styling, and a separately composed portrait layout.', category: 'CAFETERIA', orientation: 'LANDSCAPE', schoolLevel: 'ELEMENTARY', screenWidth: 3840, screenHeight: 2160, bgColor: '#2146e8', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/elem-lunch-v6-menu-lab.html' } }] },
  { id: 'preset-school-elem-lunch-7', name: "🏫 Today's Lunch — Counter Windows", description: 'Elementary three-choice lunch board — cafeteria counter windows with a striped awning and real food photography, live time, editable photos/background/logo, full brand styling, allergen line, and an authored portrait composition.', category: 'CAFETERIA', orientation: 'LANDSCAPE', schoolLevel: 'ELEMENTARY', screenWidth: 3840, screenHeight: 2160, bgColor: '#6b39ef', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/elem-lunch-v7-counter-windows.html' } }] },
  ...
  // ─── Codex k12-nonfood backlog (2026-08-21) — the bell boards are LIVE: the
  // current period, countdown and progress resolve against the time zone
  // configured on the board, not the device clock (engine inlined per board).
  { id: 'preset-hs-bell-ledger', name: '🔔 Bell Schedule — Bell Ledger', description: 'Living bell board — the current period, next-bell countdown and progress bar resolve against the time zone configured on the board, so the highlighted row is always correct. Every period row, room, name and time is operator-editable and the live states follow what you type. Authored portrait composition.', category: 'HALLWAY', orientation: 'LANDSCAPE', schoolLevel: 'HIGH', screenWidth: 3840, screenHeight: 2160, bgColor: '#f4eedf', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/hs/bell-schedule-ledger.html' } }] },
  { id: 'preset-hs-bell-orbit', name: '🔔 Bell Schedule — Signal Orbit', description: 'Living bell board — the current period, next-bell countdown and progress bar resolve against the time zone configured on the board, so the highlighted row is always correct. Every period row, room, name and time is operator-editable and the live states follow what you type. Authored portrait composition.', category: 'HALLWAY', orientation: 'LANDSCAPE', schoolLevel: 'HIGH', screenWidth: 3840, screenHeight: 2160, bgColor: '#071827', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/hs/bell-schedule-orbit.html' } }] },
  { id: 'preset-school-ms-bell-1', name: '🔔 Bell Schedule — Locker Line', description: 'Living bell board — the current period, next-bell countdown and progress bar resolve against the time zone configured on the board, so the highlighted row is always correct. Every period row, room, name and time is operator-editable and the live states follow what you type. Authored portrait composition.', category: 'HALLWAY', orientation: 'LANDSCAPE', schoolLevel: 'MIDDLE', screenWidth: 3840, screenHeight: 2160, bgColor: '#e9edf0', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/ms-bell-locker-line.html' } }] },
  { id: 'preset-school-ms-bell-2', name: '🔔 Bell Schedule — Agenda Flip', description: 'Living bell board — the current period, next-bell countdown and progress bar resolve against the time zone configured on the board, so the highlighted row is always correct. Every period row, room, name and time is operator-editable and the live states follow what you type. Authored portrait composition.', category: 'HALLWAY', orientation: 'LANDSCAPE', schoolLevel: 'MIDDLE', screenWidth: 3840, screenHeight: 2160, bgColor: '#f2f0e8', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/ms-bell-agenda-flip.html' } }] },
  { id: 'preset-school-ms-bell-3', name: '🔔 Bell Schedule — Rotation Radar', description: 'Living bell board — the current period, next-bell countdown and progress bar resolve against the time zone configured on the board, so the highlighted row is always correct. Every period row, room, name and time is operator-editable and the live states follow what you type. Authored portrait composition.', category: 'HALLWAY', orientation: 'LANDSCAPE', schoolLevel: 'MIDDLE', screenWidth: 3840, screenHeight: 2160, bgColor: '#07110f', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/ms-bell-rotation-radar.html' } }] },
  { id: 'preset-school-elem-bell-1', name: '🔔 Daily Schedule — Color Hop', description: 'Living bell board — the current period, next-bell countdown and progress bar resolve against the time zone configured on the board, so the highlighted row is always correct. Every period row, room, name and time is operator-editable and the live states follow what you type. Authored portrait composition.', category: 'HALLWAY', orientation: 'LANDSCAPE', schoolLevel: 'ELEMENTARY', screenWidth: 3840, screenHeight: 2160, bgColor: '#dff3ff', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/elem-bell-color-hop.html' } }] },
  { id: 'preset-school-elem-bell-2', name: '🔔 Daily Schedule — Classroom Daybook', description: 'Living bell board — the current period, next-bell countdown and progress bar resolve against the time zone configured on the board, so the highlighted row is always correct. Every period row, room, name and time is operator-editable and the live states follow what you type. Authored portrait composition.', category: 'HALLWAY', orientation: 'LANDSCAPE', schoolLevel: 'ELEMENTARY', screenWidth: 3840, screenHeight: 2160, bgColor: '#285448', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/elem-bell-daybook.html' } }] },
  { id: 'preset-school-elem-bell-3', name: '🔔 Daily Schedule — Sun Clock', description: 'Living bell board — the current period, next-bell countdown and progress bar resolve against the time zone configured on the board, so the highlighted row is always correct. Every period row, room, name and time is operator-editable and the live states follow what you type. Authored portrait composition.', category: 'HALLWAY', orientation: 'LANDSCAPE', schoolLevel: 'ELEMENTARY', screenWidth: 3840, screenHeight: 2160, bgColor: '#bcecff', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/elem-bell-sun-clock.html' } }] },
  { id: 'preset-hs-achievement-victory-wall', name: '🏆 Achievement Showcase — Victory Wall', description: 'Achievement showcase — student-of-the-week feature photo, honor roll and stat callouts, all editable, with an authored portrait composition.', category: 'LOBBY', orientation: 'LANDSCAPE', schoolLevel: 'HIGH', screenWidth: 3840, screenHeight: 2160, bgColor: '#071b31', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/hs/achievement-victory-wall.html' } }] },
  { id: 'preset-hs-achievement-stage-call', name: '🏆 Achievement Showcase — Stage Call', description: 'Achievement showcase — student-of-the-week feature photo, honor roll and stat callouts, all editable, with an authored portrait composition.', category: 'LOBBY', orientation: 'LANDSCAPE', schoolLevel: 'HIGH', screenWidth: 3840, screenHeight: 2160, bgColor: '#2b1734', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/hs/achievement-stage-call.html' } }] },
  { id: 'preset-school-elem-news-1', name: '📺 Morning News — Storybook Broadcast', description: 'Student-news broadcast board — real campus video hero with poster fallback, top story, coming-up rail, live/manual clock, fully replaceable video/poster/logo/background with playback and crop controls, and an authored portrait composition.', category: 'LOBBY', orientation: 'LANDSCAPE', schoolLevel: 'ELEMENTARY', screenWidth: 3840, screenHeight: 2160, bgColor: '#b9e7ff', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/elem-news-storybook.html' } }] },
  { id: 'preset-school-elem-news-2', name: '📺 Morning News — Classroom TV Cart', description: 'Student-news broadcast board — real campus video hero with poster fallback, top story, coming-up rail, live/manual clock, fully replaceable video/poster/logo/background with playback and crop controls, and an authored portrait composition.', category: 'LOBBY', orientation: 'LANDSCAPE', schoolLevel: 'ELEMENTARY', screenWidth: 3840, screenHeight: 2160, bgColor: '#f3e6c9', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/elem-news-tv-cart.html' } }] },
  { id: 'preset-school-elem-news-3', name: '📺 Morning News — Morning Mailroom', description: 'Student-news broadcast board — real campus video hero with poster fallback, top story, coming-up rail, live/manual clock, fully replaceable video/poster/logo/background with playback and crop controls, and an authored portrait composition.', category: 'LOBBY', orientation: 'LANDSCAPE', schoolLevel: 'ELEMENTARY', screenWidth: 3840, screenHeight: 2160, bgColor: '#cfe8dc', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/elem-news-mailroom.html' } }] },
  { id: 'preset-school-ms-news-1', name: '📺 Morning News — Locker Channel', description: 'Student-news broadcast board — real campus video hero with poster fallback, top story, coming-up rail, live/manual clock, fully replaceable video/poster/logo/background with playback and crop controls, and an authored portrait composition.', category: 'LOBBY', orientation: 'LANDSCAPE', schoolLevel: 'MIDDLE', screenWidth: 3840, screenHeight: 2160, bgColor: '#111a35', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/ms-news-locker-channel.html' } }] },
  { id: 'preset-school-ms-news-2', name: '📺 Morning News — Studio Switcher', description: 'Student-news broadcast board — real campus video hero with poster fallback, top story, coming-up rail, live/manual clock, fully replaceable video/poster/logo/background with playback and crop controls, and an authored portrait composition.', category: 'LOBBY', orientation: 'LANDSCAPE', schoolLevel: 'MIDDLE', screenWidth: 3840, screenHeight: 2160, bgColor: '#090c12', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/ms-news-studio-switcher.html' } }] },
  { id: 'preset-school-ms-news-3', name: '📺 Morning News — Notebook Cut', description: 'Student-news broadcast board — real campus video hero with poster fallback, top story, coming-up rail, live/manual clock, fully replaceable video/poster/logo/background with playback and crop controls, and an authored portrait composition.', category: 'LOBBY', orientation: 'LANDSCAPE', schoolLevel: 'MIDDLE', screenWidth: 3840, screenHeight: 2160, bgColor: '#1b3e34', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/ms-news-notebook-cut.html' } }] },
  { id: 'preset-school-elem-wayfinder-1', name: '🧭 Wayfinder — Color Trail', description: 'Campus navigation board — color-keyed routes with rooms and directions, you-are-here map, live/manual clock, notice band. Fully editable routes, map labels and school logo; authored portrait composition.', category: 'HALLWAY_DISPLAY', orientation: 'LANDSCAPE', schoolLevel: 'ELEMENTARY', screenWidth: 3840, screenHeight: 2160, bgColor: '#dff5ff', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/elem-wayfinder-color-trail.html' } }] },
  { id: 'preset-school-elem-wayfinder-2', name: '🧭 Wayfinder — Schoolhouse Neighborhood', description: 'Campus navigation board — color-keyed routes with rooms and directions, you-are-here map, live/manual clock, notice band. Fully editable routes, map labels and school logo; authored portrait composition.', category: 'HALLWAY_DISPLAY', orientation: 'LANDSCAPE', schoolLevel: 'ELEMENTARY', screenWidth: 3840, screenHeight: 2160, bgColor: '#657386', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/elem-wayfinder-neighborhood.html' } }] },
  { id: 'preset-school-elem-wayfinder-3', name: '🧭 Wayfinder — Mascot Signpost', description: 'Campus navigation board — color-keyed routes with rooms and directions, you-are-here map, live/manual clock, notice band. Fully editable routes, map labels and school logo; authored portrait composition.', category: 'HALLWAY_DISPLAY', orientation: 'LANDSCAPE', schoolLevel: 'ELEMENTARY', screenWidth: 3840, screenHeight: 2160, bgColor: '#bcecff', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/elem-wayfinder-mascot-signpost.html' } }] },
  { id: 'preset-school-ms-wayfinder-1', name: '🧭 Wayfinder — Locker Compass', description: 'Campus navigation board — color-keyed routes with rooms and directions, you-are-here map, live/manual clock, notice band. Fully editable routes, map labels and school logo; authored portrait composition.', category: 'HALLWAY_DISPLAY', orientation: 'LANDSCAPE', schoolLevel: 'MIDDLE', screenWidth: 3840, screenHeight: 2160, bgColor: '#f4f0e7', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/ms-wayfinder-locker-compass.html' } }] },
  { id: 'preset-school-ms-wayfinder-2', name: '🧭 Wayfinder — Campus Patchboard', description: 'Campus navigation board — color-keyed routes with rooms and directions, you-are-here map, live/manual clock, notice band. Fully editable routes, map labels and school logo; authored portrait composition.', category: 'HALLWAY_DISPLAY', orientation: 'LANDSCAPE', schoolLevel: 'MIDDLE', screenWidth: 3840, screenHeight: 2160, bgColor: '#d6b483', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/ms-wayfinder-patchboard.html' } }] },
  { id: 'preset-school-ms-wayfinder-3', name: '🧭 Wayfinder — Courtline Routes', description: 'Campus navigation board — color-keyed routes with rooms and directions, you-are-here map, live/manual clock, notice band. Fully editable routes, map labels and school logo; authored portrait composition.', category: 'HALLWAY_DISPLAY', orientation: 'LANDSCAPE', schoolLevel: 'MIDDLE', screenWidth: 3840, screenHeight: 2160, bgColor: '#d49a58', zones: [{ name: 'Scene', widgetType: 'EXTERNAL_HTML', x: 0, y: 0, width: 100, height: 100, zIndex: 1, sortOrder: 0, defaultConfig: { url: '/templates/school/ms-wayfinder-courtline.html' } }] },
