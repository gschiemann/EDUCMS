...
export const DESIGNER_ART_DIRECTIONS: string[] = [
  'Bold editorial — a large hero photograph (full-bleed or a strong side panel) with a confident headline over a legibility scrim; magazine-cover energy.',
  'Clean & premium — minimal, lots of intentional whitespace, a refined type pairing and a single restrained accent; Aesop/Apple calm. Photo optional + subtle.',
  'Vibrant & graphic — color-blocked panels or a rich gradient, oversized type, a lively accent; high-impact and scroll-stopping while staying on-brand.',
];
