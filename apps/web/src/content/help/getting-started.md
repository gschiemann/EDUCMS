...
On the actual display — a Chromebook, Fire TV, smart TV browser, or Raspberry Pi — open `venue-os.app/player` and enter that pairing code. The screen is now bound to your tenant. Once paired, it will show your default template until you schedule something else.
...
Stuck? Email support@venue-os.app and a human will get back to you within one school day.
