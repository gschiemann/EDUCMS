  ...
  return (
    <>
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-5">
        {/* Per-screen emergency content — the ONLY config in this drawer.
            Operator (2026-04-27): "remove the top section... remove the
            trigger emergency button... just allow for the drag and drop
            of the unused screens and the upload of each individual
            emergency content." Status, manual trigger, and the playlist
            dropdown are gone. Pure upload UX: 12 zones (6 types × 2
            orientations), each accepts an image / video / PDF. */}
