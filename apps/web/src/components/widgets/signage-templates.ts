...
export const SIGNAGE_TEMPLATES: SignageTemplate[] = [
  ...
  { id: "preset-sig-qsr-25-super-taco-tacos-portrait", name: "Super Taco · Menu Wall 1 · Tacos · Portrait", group: "QSR", url: "/templates/signage/qsr/25-super-taco-tacos.html?orientation=portrait" },
  { id: "preset-sig-qsr-26-super-taco-burritos-portrait", name: "Super Taco · Menu Wall 2 · Burritos & More · Portrait", group: "QSR", url: "/templates/signage/qsr/26-super-taco-burritos.html?orientation=portrait" },
  { id: "preset-sig-qsr-27-super-taco-combos-portrait", name: "Super Taco · Menu Wall 3 · Combo Spotlight · Portrait", group: "QSR", url: "/templates/signage/qsr/27-super-taco-combos.html?orientation=portrait" },
