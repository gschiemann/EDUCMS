...
export const SIGNAGE_TEMPLATES: SignageTemplate[] = [
  ...
  { id: "preset-hs-hall-wayfinder", name: "Hallway — Departures Board", group: "High School", url: "/templates/hs/hall-wayfinder.html" },
  ...
  { id: "preset-hs-transit", name: "Transit — Airport Departure Board", group: "High School", url: "/templates/hs/hall-wayfinder.html" },
