  ...
  return (
    ...
    >
      ...
      <header className="ms-hr-hud">
        <div className="ms-hr-brand" data-widget="school">
          <div className="ms-hr-badge" aria-hidden="true">
            ...
            <div className="ms-hr-lvl" data-field="school.team">
              {pick(cfg, 'school.team')}
            </div>
          </div>
          <div className="ms-hr-info">
            <div className="ms-hr-eye">Welcome, Otters</div>
            <div className="ms-hr-name" data-field="school.name">
        ...
        <div className="ms-hr-stamp" data-widget="day">
          <div className="ms-hr-stamp-lab" data-field="day.label">
            {pick(cfg, 'day.label')}
          </div>
        ...
        <div className="ms-hr-tiles">
          <div className="ms-hr-tile" data-widget="clock">
            <span className="ms-hr-tile-k" data-field="clock.label">
              {pick(cfg, 'clock.label')}
            </span>
            <span className="ms-hr-tile-v" data-field="clock.time">
              {pick(cfg, 'clock.time')}
            </span>
          </div>
          <div className="ms-hr-tile" data-widget="weather">
            <span className="ms-hr-tile-k" data-field="weather.label">
              {pick(cfg, 'weather.label')}
            </span>
            <span className="ms-hr-tile-v ms-hr-cool" data-field="weather.temp">
              {pick(cfg, 'weather.temp')}
            </span>
          </div>
          <div className="ms-hr-tile" data-widget="weather2">
            <span className="ms-hr-tile-k" data-field="weather2.label">
              {pick(cfg, 'weather2.label')}
            </span>
            <span className="ms-hr-tile-v ms-hr-sun" data-field="weather2.cond">
      ...
      <section className="ms-hr-hero" data-widget="greeting">
        ...
        <div className="ms-hr-greet-eye" data-field="greeting.eyebrow">
        ...
        <p className="ms-hr-hero-sub" data-field="greeting.subtitle">
      ...
      <aside className="ms-hr-right">
        <div className="ms-hr-polaroid" data-widget="shoutouts">
          ...
          <div className="ms-hr-pol-ey" data-field="shoutouts.label">
            {pick(cfg, 'shoutouts.label')}
          </div>
          <h3 className="ms-hr-pol-title" data-field="shoutouts.title">
            ...
            {([0, 1, 2] as const).map((i) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="ms-hr-who" data-field={`shoutouts.${i}.who`}>
        ...
        <div className="ms-hr-countdown" data-widget="countdown">
          ...
          <div className="ms-hr-cd-row">
            <div className="ms-hr-cd-num" data-field="countdown.value">
              {pick(cfg, 'countdown.value')}
            </div>
            <div className="ms-hr-cd-meta" data-field="countdown.meta">
      ...
      <section className="ms-hr-agenda" data-widget="agenda">
        <div className="ms-hr-ag-head">
          <h2 className="ms-hr-ag-title" data-field="agenda.title">
            ...
            return (
              <div className={cls} data-widget={`agenda.${i}`} key={i}>
                <div className="ms-hr-card-top">
                  <span className="ms-hr-card-p" data-field={`agenda.${i}.p`}>
                    {pick(cfg, `agenda.${i}.p` as keyof Required<MsHomeroomConfig>)}
                  </span>
                  <span className="ms-hr-card-t" data-field={`agenda.${i}.time`}>
                    {pick(cfg, `agenda.${i}.time` as keyof Required<MsHomeroomConfig>)}
                  </span>
                </div>
                <div className="ms-hr-card-c" data-field={`agenda.${i}.c`}>
                ...
                <div className="ms-hr-card-r">
                  ...
                  <br />
                  <span data-field={`agenda.${i}.teacher`}>
      ...
      <section className="ms-hr-lower">
        ...
        <div className="ms-hr-lunchbag" data-widget="lunch">
          <div className="ms-hr-bag">
            <div className="ms-hr-receipt" data-field="lunch.receipt">
              {pick(cfg, 'lunch.receipt')}
            </div>
            <div className="ms-hr-bag-ey" data-field="lunch.label">
              {pick(cfg, 'lunch.label')}
            </div>
            <div className="ms-hr-entree" data-field="lunch.entree">
              {pick(cfg, 'lunch.entree')}
            </div>
            <div className="ms-hr-sides" data-field="lunch.sides">
              {pick(cfg, 'lunch.sides')}
            </div>
            <div className="ms-hr-tags">
              <span className="ms-hr-tag ms-hr-tag-veg" data-field="lunch.tag1">
                {pick(cfg, 'lunch.tag1')}
              </span>
              <span className="ms-hr-tag ms-hr-tag-gf" data-field="lunch.tag2">
                {pick(cfg, 'lunch.tag2')}
              </span>
              <span className="ms-hr-tag ms-hr-tag-df" data-field="lunch.tag3">
                {pick(cfg, 'lunch.tag3')}
              </span>
            </div>
          </div>
        ...
        <div className="ms-hr-buses" data-widget="buses">
          <div className="ms-hr-bus-head">
            <span className="ms-hr-bus-t" data-field="buses.title">
              {pick(cfg, 'buses.title')}
            </span>
            <span className="ms-hr-bus-ey" data-field="buses.label">
            ...
            {([0, 1, 2] as const).map((i) => {
              ...
              return (
                <div className="ms-hr-bus" data-widget={`buses.${i}`} key={i}>
                  <span className="ms-hr-bus-num" data-field={`buses.${i}.num`}>
                    {pick(cfg, `buses.${i}.num` as keyof Required<MsHomeroomConfig>)}
                  </span>
                  <div className="ms-hr-bus-info">
                    <div className="ms-hr-bus-rt" data-field={`buses.${i}.rt`}>
                      {pick(cfg, `buses.${i}.rt` as keyof Required<MsHomeroomConfig>)}
                    </div>
                    <div className="ms-hr-bus-sub" data-field={`buses.${i}.sub`}>
        ...
        <div className="ms-hr-folder" data-widget="clubs">
          ...
          <div className="ms-hr-folder-ey" data-field="clubs.label">
            {pick(cfg, 'clubs.label')}
          </div>
          <h3 className="ms-hr-folder-title" data-field="clubs.title">
          ...
          <div className="ms-hr-folder-list">
            {([0, 1, 2] as const).map((i) => (
              <div className="ms-hr-folder-row" data-widget={`clubs.${i}`} key={i}>
                ...
                />
                <span className="ms-hr-folder-n" data-field={`clubs.${i}.n`}>
                ...
                <span className="ms-hr-folder-w" data-field={`clubs.${i}.w`}>
      ...
      <div className="ms-hr-ticker" data-widget="announcement">
        <div className="ms-hr-ticker-badge" data-field="announcement.badge">
