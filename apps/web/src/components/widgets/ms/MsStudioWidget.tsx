 ...
 */
const pickStatic = <K extends keyof Required<MsStudioConfig>>(
  cfg: MsStudioConfig,
  key: K,
): string => {
  const v = cfg[key];
...
export function MsStudioWidget({ config, live }: { config?: MsStudioConfig; live?: boolean }) {
  const cfg = config || {};
  ...
  const pick = <K extends keyof Required<MsStudioConfig>>(key: K): string => {
    const v = cfg[key];
          ...
          <div className="ms-st-turntable" data-widget="feature">
            <div className="ms-st-tt-head">
              ...
              <div className="ms-st-tt-meta">
                <b data-field="feature.eye" style={{ whiteSpace: 'pre-wrap' }}>{pick('feature.eye')}</b> · A-Side
              </div>
            </div>
            ...
            <div className="ms-st-now-spinning">
              ...
              <span className="ms-st-tg">
                Track <b data-field="feature.tag" style={{ whiteSpace: 'pre-wrap' }}>{pick('feature.tag')}</b>
              </span>
            </div>
          </div>
          ...
          <div className="ms-st-control-row">
            <div className="ms-st-vu" data-widget="vu">
              ...
              <div className="ms-st-vu-feet">
                <span data-field="vu.feet0" style={{ whiteSpace: 'pre-wrap' }}>{pick('vu.feet0')}</span>
                <span>
                  <b data-field="vu.feet1" style={{ whiteSpace: 'pre-wrap' }}>{pick('vu.feet1')}</b> live
                </span>
              </div>
            </div>
