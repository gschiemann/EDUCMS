  ...
  return (
    ...
    >
      ...
      <header className="ms-pp-p-wxrow">
        ...
        <div className="ms-pp-p-lefttiles" data-widget="weather-cluster">
          <div className="ms-pp-p-tile ms-pp-p-warm" data-widget="weather">
            <span className="ms-pp-p-k" data-field="weather.label" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'weather.label')}</span>
          ...
          <div className="ms-pp-p-tile" data-widget="weather-low">
            <span className="ms-pp-p-k" data-field="weather.low_label" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'weather.low_label')}</span>
            <span className="ms-pp-p-v">
          ...
          <div className="ms-pp-p-tile ms-pp-p-full" data-widget="weather-summary">
            <span className="ms-pp-p-k" data-field="weather.sky_label" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'weather.sky_label')}</span>
            <span className="ms-pp-p-v">
      ...
      <header className="ms-pp-p-mast" data-widget="masthead">
        <div className="ms-pp-p-ribbon" data-field="masthead.kicker" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'masthead.kicker')}</div>
        <div className="ms-pp-p-title">
          <span className="ms-pp-p-the" data-field="masthead.the" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'masthead.the')}</span>
          <span data-field="masthead.mascot" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'masthead.mascot')}</span>
          &nbsp;
          <span className="ms-pp-p-accent" data-field="masthead.suffix" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'masthead.suffix')}</span>
        </div>
        <div className="ms-pp-p-tagline" data-field="masthead.tagline" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'masthead.tagline')}</div>
      </header>
      ...
      <div className="ms-pp-p-indicia" data-widget="indicia">
        <span className="ms-pp-p-vol" data-field="indicia.vol" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'indicia.vol')}</span>
        <span className="ms-pp-p-date" data-field="indicia.date" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'indicia.date')}</span>
        <span className="ms-pp-p-pipe">|</span>
        <span className="ms-pp-p-red" data-field="indicia.flag" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'indicia.flag')}</span>
        <span className="ms-pp-p-pipe">|</span>
      ...
      <article className="ms-pp-p-lead" data-widget="greeting">
        <div className="ms-pp-p-deptline">
          ...
          <span className="ms-pp-p-label" data-field="greeting.dept" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'greeting.dept')}</span>
          <span className="ms-pp-p-pipe-line" aria-hidden="true" />
          <span className="ms-pp-p-edition" data-field="greeting.edition" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'greeting.edition')}</span>
        </div>

        <h1 className="ms-pp-p-h1">
          <span className="ms-pp-p-small" data-field="greeting.kicker" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'greeting.kicker')}</span>
        ...
        <p className="ms-pp-p-deck" data-field="greeting.deck" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'greeting.deck')}</p>
        ...
        <div className="ms-pp-p-body">
          <div className="ms-pp-p-col ms-pp-p-first">
            ...
            <div className="ms-pp-p-pullquote">
              ...
              <span className="ms-pp-p-who" data-field="greeting.pq_who" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'greeting.pq_who')}</span>
            </div>
          </div>
      ...
      <aside className="ms-pp-p-sidebar" data-widget="agenda">
        ...
        <div className="ms-pp-p-stats">
          <div className="ms-pp-p-s ms-pp-p-featured" data-widget="countdown">
            <span className="ms-pp-p-k" data-field="countdown.label" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'countdown.label')}</span>
            <span className="ms-pp-p-v">
              <span data-field="countdown.value" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'countdown.value')}</span>
            </span>
            <span className="ms-pp-p-sub" data-field="countdown.sub" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'countdown.sub')}</span>
          </div>
          <div className="ms-pp-p-s" data-widget="attendance">
            <span className="ms-pp-p-k" data-field="attendance.label" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'attendance.label')}</span>
            <span className="ms-pp-p-v">
            ...
            <span className="ms-pp-p-sub" data-field="attendance.sub" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'attendance.sub')}</span>
          </div>
        </div>
      </aside>
      ...
      <section className="ms-pp-p-depts">
        ...
        <div className="ms-pp-p-dept ms-pp-p-dining" data-widget="lunch">
          <div className="ms-pp-p-slug">
            <span className="ms-pp-p-num" data-field="lunch.num" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'lunch.num')}</span>
            ...
            <span className="ms-pp-p-meta" data-field="lunch.meta" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'lunch.meta')}</span>
          </div>
          <div className="ms-pp-p-entree" data-field="lunch.entree" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'lunch.entree')}</div>
          <div className="ms-pp-p-sides" data-field="lunch.sides" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'lunch.sides')}</div>
          <div className="ms-pp-p-tags">
            ...
            <b className="ms-pp-p-red-tag" data-field="lunch.tag3" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'lunch.tag3')}</b>
          </div>
        </div>
        ...
        <div className="ms-pp-p-dept ms-pp-p-clubs" data-widget="clubs">
          <div className="ms-pp-p-slug">
            <span className="ms-pp-p-num" data-field="clubs.num" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'clubs.num')}</span>
            <span className="ms-pp-p-name">
            ...
            <span className="ms-pp-p-meta" data-field="clubs.meta" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'clubs.meta')}</span>
          </div>
        ...
        <div className="ms-pp-p-dept ms-pp-p-shoutouts" data-widget="shoutouts">
          <div className="ms-pp-p-slug">
            <span className="ms-pp-p-num" data-field="shoutouts.num" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'shoutouts.num')}</span>
            <span className="ms-pp-p-name">
            ...
            <span className="ms-pp-p-meta" data-field="shoutouts.meta" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'shoutouts.meta')}</span>
          </div>
          <div className="ms-pp-p-list">
            {([0, 1, 2] as const).map((i) => {
              const icoClass = i === 0 ? 'ms-pp-p-ico-red' : i === 2 ? 'ms-pp-p-ico-cream' : '';
      ...
      <div className="ms-pp-p-ticker" data-widget="ticker">
        <div className="ms-pp-p-tag" data-field="ticker.tag" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'ticker.tag')}</div>
        ...
        <div className="ms-pp-p-vol-end" data-field="ticker.endmark" style={{ whiteSpace: 'pre-wrap' }}>{pick(cfg, 'ticker.endmark')}</div>
      </div>
    </HsStage>
  );
}
