...
const pickStatic = <K extends keyof Required<MsPaperPortraitConfig>>(
...
export function MsPaperPortraitWidget({
  ...
  config?: MsPaperPortraitConfig; live?: boolean
}) {
  const cfg = config || {};
  ...
  const pick = <K extends keyof Required<MsPaperPortraitConfig>>(key: K): string => {
    const v = cfg[key];
  ...
  return (
    ...
    >
      ...
      <header className="ms-pp-p-wxrow">
        ...
        <div className="ms-pp-p-lefttiles" data-widget="weather-cluster">
          <div className="ms-pp-p-tile ms-pp-p-warm" data-widget="weather">
            <span className="ms-pp-p-k" data-field="weather.label" style={{ whiteSpace: 'pre-wrap' }}>{pick('weather.label')}</span>
          ...
          <div className="ms-pp-p-tile" data-widget="weather-low">
            <span className="ms-pp-p-k" data-field="weather.low_label" style={{ whiteSpace: 'pre-wrap' }}>{pick('weather.low_label')}</span>
            <span className="ms-pp-p-v">
          ...
          <div className="ms-pp-p-tile ms-pp-p-full" data-widget="weather-summary">
            <span className="ms-pp-p-k" data-field="weather.sky_label" style={{ whiteSpace: 'pre-wrap' }}>{pick('weather.sky_label')}</span>
            <span className="ms-pp-p-v">
      ...
      <header className="ms-pp-p-mast" data-widget="masthead">
        {pick('masthead.logoUrl') ? (
          <img
            ...
            style={{ height: 150, width: 'auto', objectFit: 'contain', display: 'block', margin: '0 auto 12px' }}
          />
        ) : null}
        <div className="ms-pp-p-ribbon" data-field="masthead.kicker" style={{ whiteSpace: 'pre-wrap' }}>{pick('masthead.kicker')}</div>
        <div className="ms-pp-p-title">
          <span className="ms-pp-p-the" data-field="masthead.the" style={{ whiteSpace: 'pre-wrap' }}>{pick('masthead.the')}</span>
          <span data-field="masthead.mascot" style={{ whiteSpace: 'pre-wrap' }}>{pick('masthead.mascot')}</span>
          &nbsp;
          <span className="ms-pp-p-accent" data-field="masthead.suffix" style={{ whiteSpace: 'pre-wrap' }}>{pick('masthead.suffix')}</span>
        </div>
        <div className="ms-pp-p-tagline" data-field="masthead.tagline" style={{ whiteSpace: 'pre-wrap' }}>{pick('masthead.tagline')}</div>
      </header>
      ...
      <div className="ms-pp-p-indicia" data-widget="indicia">
        <span className="ms-pp-p-vol" data-field="indicia.vol" style={{ whiteSpace: 'pre-wrap' }}>{pick('indicia.vol')}</span>
        <span className="ms-pp-p-date" data-field="indicia.date" style={{ whiteSpace: 'pre-wrap' }}>{pick('indicia.date')}</span>
        <span className="ms-pp-p-pipe">|</span>
        <span className="ms-pp-p-red" data-field="indicia.flag" style={{ whiteSpace: 'pre-wrap' }}>{pick('indicia.flag')}</span>
        <span className="ms-pp-p-pipe">|</span>
      ...
      <article className="ms-pp-p-lead" data-widget="greeting">
        <div className="ms-pp-p-deptline">
          ...
          <span className="ms-pp-p-label" data-field="greeting.dept" style={{ whiteSpace: 'pre-wrap' }}>{pick('greeting.dept')}</span>
          <span className="ms-pp-p-pipe-line" aria-hidden="true" />
          <span className="ms-pp-p-edition" data-field="greeting.edition" style={{ whiteSpace: 'pre-wrap' }}>{pick('greeting.edition')}</span>
        </div>

        <h1 className="ms-pp-p-h1">
          <span className="ms-pp-p-small" data-field="greeting.kicker" style={{ whiteSpace: 'pre-wrap' }}>{pick('greeting.kicker')}</span>
        ...
        <p className="ms-pp-p-deck" data-field="greeting.deck" style={{ whiteSpace: 'pre-wrap' }}>{pick('greeting.deck')}</p>
        ...
        <div className="ms-pp-p-body">
          <div className="ms-pp-p-col ms-pp-p-first">
            ...
            <div className="ms-pp-p-pullquote">
              ...
              <span className="ms-pp-p-who" data-field="greeting.pq_who" style={{ whiteSpace: 'pre-wrap' }}>{pick('greeting.pq_who')}</span>
            </div>
          </div>
          <div className="ms-pp-p-col">
            ...
            <div className="ms-pp-p-photo" data-widget="photo">
              <div className="ms-pp-p-frame" aria-hidden={!pick('photo.imageUrl') || undefined} data-field="photo.imageUrl">
                {pick('photo.imageUrl') ? (
                  <img
              ...
              <div className="ms-pp-p-caption" data-field="photo.caption" style={{ whiteSpace: 'pre-wrap' }}>
      ...
      <aside className="ms-pp-p-sidebar" data-widget="agenda">
        ...
        <div className="ms-pp-p-toc">
          {([0, 1, 2, 3, 4, 5, 6] as const).map((i) => {
            ...
            return (
              ...
              >
                <span className="ms-pp-p-p" data-field={`agenda.${i}.p`} style={{ whiteSpace: 'pre-wrap' }}>
                  {pick(`agenda.${i}.p` as keyof Required<MsPaperPortraitConfig>)}
                </span>
                <span className="ms-pp-p-what">
                  <span data-field={`agenda.${i}.t`} style={{ whiteSpace: 'pre-wrap' }}>
                    {pick(`agenda.${i}.t` as keyof Required<MsPaperPortraitConfig>)}
                  </span>
                  <span data-field={`agenda.${i}.r`} style={{ whiteSpace: 'pre-wrap' }}>
                    {pick(`agenda.${i}.r` as keyof Required<MsPaperPortraitConfig>)}
                  </span>
                </span>
                <span className="ms-pp-p-pg" data-field={`agenda.${i}.time`} style={{ whiteSpace: 'pre-wrap' }}>
                  {pick(`agenda.${i}.time` as keyof Required<MsPaperPortraitConfig>)}
                </span>
              </div>
            );
          })}
        ...
        <div className="ms-pp-p-stats">
          <div className="ms-pp-p-s ms-pp-p-featured" data-widget="countdown">
            <span className="ms-pp-p-k" data-field="countdown.label" style={{ whiteSpace: 'pre-wrap' }}>{pick('countdown.label')}</span>
            <span className="ms-pp-p-v">
              <span data-field="countdown.value" style={{ whiteSpace: 'pre-wrap' }}>{pick('countdown.value')}</span>
            </span>
            <span className="ms-pp-p-sub" data-field="countdown.sub" style={{ whiteSpace: 'pre-wrap' }}>{pick('countdown.sub')}</span>
          </div>
          <div className="ms-pp-p-s" data-widget="attendance">
            <span className="ms-pp-p-k" data-field="attendance.label" style={{ whiteSpace: 'pre-wrap' }}>{pick('attendance.label')}</span>
            <span className="ms-pp-p-v">
            ...
            <span className="ms-pp-p-sub" data-field="attendance.sub" style={{ whiteSpace: 'pre-wrap' }}>{pick('attendance.sub')}</span>
          </div>
        </div>
      </aside>
      ...
      <section className="ms-pp-p-depts">
        ...
        <div className="ms-pp-p-dept ms-pp-p-dining" data-widget="lunch">
          <div className="ms-pp-p-slug">
            <span className="ms-pp-p-num" data-field="lunch.num" style={{ whiteSpace: 'pre-wrap' }}>{pick('lunch.num')}</span>
            ...
            <span className="ms-pp-p-meta" data-field="lunch.meta" style={{ whiteSpace: 'pre-wrap' }}>{pick('lunch.meta')}</span>
          </div>
          <div className="ms-pp-p-entree" data-field="lunch.entree" style={{ whiteSpace: 'pre-wrap' }}>{pick('lunch.entree')}</div>
          <div className="ms-pp-p-sides" data-field="lunch.sides" style={{ whiteSpace: 'pre-wrap' }}>{pick('lunch.sides')}</div>
          <div className="ms-pp-p-tags">
            ...
            <b className="ms-pp-p-red-tag" data-field="lunch.tag3" style={{ whiteSpace: 'pre-wrap' }}>{pick('lunch.tag3')}</b>
          </div>
        </div>
        ...
        <div className="ms-pp-p-dept ms-pp-p-clubs" data-widget="clubs">
          <div className="ms-pp-p-slug">
            <span className="ms-pp-p-num" data-field="clubs.num" style={{ whiteSpace: 'pre-wrap' }}>{pick('clubs.num')}</span>
            <span className="ms-pp-p-name">
            ...
            <span className="ms-pp-p-meta" data-field="clubs.meta" style={{ whiteSpace: 'pre-wrap' }}>{pick('clubs.meta')}</span>
          </div>
                ...
                <div key={i} className="ms-pp-p-it" data-widget={`clubs.${i}`}>
                  <div
                   ...
                   style={{ whiteSpace: 'pre-wrap' }}>
                    {pick(`clubs.${i}.ic` as keyof Required<MsPaperPortraitConfig>)}
                  </div>
                  <div className="ms-pp-p-info">
                    <div className="ms-pp-p-t" data-field={`clubs.${i}.t`} style={{ whiteSpace: 'pre-wrap' }}>
                      {pick(`clubs.${i}.t` as keyof Required<MsPaperPortraitConfig>)}
                    </div>
                    <div className="ms-pp-p-s-it" data-field={`clubs.${i}.r`} style={{ whiteSpace: 'pre-wrap' }}>
                      {pick(`clubs.${i}.r` as keyof Required<MsPaperPortraitConfig>)}
                    </div>
                  </div>
                  <div className="ms-pp-p-when">
                    <span data-field={`clubs.${i}.w`} style={{ whiteSpace: 'pre-wrap' }}>
                      {pick(`clubs.${i}.w` as keyof Required<MsPaperPortraitConfig>)}
                    </span>
                    <small data-field={`clubs.${i}.note`} style={{ whiteSpace: 'pre-wrap' }}>
                      {pick(`clubs.${i}.note` as keyof Required<MsPaperPortraitConfig>)}
                    </small>
                  </div>
                </div>
              );
        ...
        <div className="ms-pp-p-dept ms-pp-p-shoutouts" data-widget="shoutouts">
          <div className="ms-pp-p-slug">
            <span className="ms-pp-p-num" data-field="shoutouts.num" style={{ whiteSpace: 'pre-wrap' }}>{pick('shoutouts.num')}</span>
            <span className="ms-pp-p-name">
            ...
            <span className="ms-pp-p-meta" data-field="shoutouts.meta" style={{ whiteSpace: 'pre-wrap' }}>{pick('shoutouts.meta')}</span>
          </div>
          <div className="ms-pp-p-list">
            {([0, 1, 2] as const).map((i) => {
              const icoClass = i === 0 ? 'ms-pp-p-ico-red' : i === 2 ? 'ms-pp-p-ico-cream' : '';
              return (
                <div key={i} className="ms-pp-p-it" data-widget={`shoutouts.${i}`}>
                  <div
                   ...
                   style={{ whiteSpace: 'pre-wrap' }}>
                    {pick(`shoutouts.${i}.ic` as keyof Required<MsPaperPortraitConfig>)}
                  </div>
                  <div className="ms-pp-p-info">
                    <div className="ms-pp-p-t" data-field={`shoutouts.${i}.t`} style={{ whiteSpace: 'pre-wrap' }}>
                      {pick(`shoutouts.${i}.t` as keyof Required<MsPaperPortraitConfig>)}
                    </div>
                    <div className="ms-pp-p-s-it" data-field={`shoutouts.${i}.r`} style={{ whiteSpace: 'pre-wrap' }}>
                      {pick(`shoutouts.${i}.r` as keyof Required<MsPaperPortraitConfig>)}
                    </div>
                  </div>
                  <div className="ms-pp-p-when">
                    <span data-field={`shoutouts.${i}.w`} style={{ whiteSpace: 'pre-wrap' }}>
                      {pick(`shoutouts.${i}.w` as keyof Required<MsPaperPortraitConfig>)}
                    </span>
                    <small data-field={`shoutouts.${i}.note`} style={{ whiteSpace: 'pre-wrap' }}>
                      {pick(`shoutouts.${i}.note` as keyof Required<MsPaperPortraitConfig>)}
                    </small>
                  </div>
                </div>
              );
      ...
      <div className="ms-pp-p-ticker" data-widget="ticker">
        <div className="ms-pp-p-tag" data-field="ticker.tag" style={{ whiteSpace: 'pre-wrap' }}>{pick('ticker.tag')}</div>
        <div className="ms-pp-p-feed">
          <div className="ms-pp-p-feed-inner">
            {([0, 1, 2, 3, 4, 5, 6] as const).map((i) => (
              <span key={`a${i}`} data-field={`ticker.${i}`} style={{ whiteSpace: 'pre-wrap' }}>
                {pick(`ticker.${i}` as keyof Required<MsPaperPortraitConfig>)}
              </span>
            ))}
        ...
        <div className="ms-pp-p-vol-end" data-field="ticker.endmark" style={{ whiteSpace: 'pre-wrap' }}>{pick('ticker.endmark')}</div>
      </div>
    </HsStage>
  );
}
