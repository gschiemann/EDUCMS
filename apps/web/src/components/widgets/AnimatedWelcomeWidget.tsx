  ...
  return (
    ...
    >
      {/* Specificity-boosted — see scene-css.ts. Flattened Tailwind
          preflight outranks plain class selectors (2026-08-09); without
          this the title renders at 16px and every padding/margin in the
          scene is zeroed. sceneCss() is memoized, so this costs a Map hit
          per render and emits identical text on server and client. */}
