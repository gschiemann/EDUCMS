...
.hs-bp-titleblock { position: absolute; top: 40px; left: 40px; right: 40px; height: 220px; border: 3px solid #6ab6ff; display: grid; grid-template-columns: 420px 1fr 620px 420px; background: rgba(10,40,82,.6); }
.hs-bp-cell { border-right: 2px solid #6ab6ff; padding: 16px 28px; display: flex; flex-direction: column; justify-content: center; }
.hs-bp-cell:last-child { border-right: 0; }
.hs-bp-lbl { font-family: 'JetBrains Mono', monospace; font-size: 48px; letter-spacing: .2em; color: #6ab6ff; text-transform: uppercase; opacity: .85; }
.hs-bp-val { font-family: 'Archivo', sans-serif; font-weight: 900; font-size: 76px; color: #eaf3ff; letter-spacing: .02em; line-height: 1; margin-top: 8px; }
.hs-bp-logo { font-family: 'Archivo', sans-serif; font-weight: 900; font-size: 130px; color: #ffd84d; line-height: .9; letter-spacing: .02em; }
.hs-bp-logo-sub { display: block; font-family: 'JetBrains Mono', monospace; font-size: 48px; letter-spacing: .25em; color: #eaf3ff; margin-top: 8px; opacity: .8; font-weight: 500; }
.hs-bp-rev { background: #ffd84d; color: #0a2852; }
.hs-bp-rev .hs-bp-lbl { color: #0a2852; opacity: 1; }
.hs-bp-rev .hs-bp-val { color: #0a2852; font-size: 60px; }
.hs-bp-hero { position: absolute; top: 300px; left: 40px; width: 2300px; height: 880px; border: 3px solid #6ab6ff; background: rgba(10,40,82,.3); padding: 60px 80px; }
.hs-bp-hero::before { content: 'SHEET A-01'; position: absolute; top: -22px; left: 40px; background: #0f3a7a; padding: 0 16px; font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 48px; letter-spacing: .26em; color: #ffd84d; text-transform: uppercase; }
.hs-bp-eyebrow { font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 64px; letter-spacing: .24em; color: #ffd84d; text-transform: uppercase; margin-bottom: 18px; }
...
.hs-bp-sub { font-family: 'Archivo', sans-serif; font-weight: 500; font-size: 90px; color: #6ab6ff; line-height: 1.2; margin-top: 32px; max-width: 1900px; }
.hs-bp-dim { position: absolute; font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 52px; color: #ffd84d; letter-spacing: .16em; text-transform: uppercase; pointer-events: none; }
...
.hs-bp-data { position: absolute; top: 300px; right: 40px; width: 1420px; height: 880px; display: grid; grid-template-columns: 1fr 1fr; grid-template-rows: 1fr 1fr; gap: 28px; }
.hs-bp-panel { border: 3px solid #6ab6ff; background: rgba(10,40,82,.45); padding: 28px 32px; position: relative; }
.hs-bp-panel::before { content: attr(data-sheet); position: absolute; top: -22px; left: 28px; background: #0f3a7a; padding: 0 14px; font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 46px; color: #ffd84d; letter-spacing: .24em; text-transform: uppercase; }
.hs-bp-kicker { font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 60px; color: #6ab6ff; letter-spacing: .2em; text-transform: uppercase; }
...
.hs-bp-cap { font-family: 'Archivo', sans-serif; font-weight: 500; font-size: 64px; color: #6ab6ff; margin-top: 12px; line-height: 1.2; }
.hs-bp-sched { position: absolute; top: 1210px; left: 40px; right: 40px; height: 440px; border: 3px solid #6ab6ff; background: rgba(10,40,82,.3); padding: 40px 56px; }
.hs-bp-sched::before { content: 'SHEET A-02 · SCHEDULE'; position: absolute; top: -22px; left: 40px; background: #0f3a7a; padding: 0 16px; font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 48px; color: #ffd84d; letter-spacing: .24em; }
.hs-bp-sched-head { display: grid; grid-template-columns: 240px 280px 1fr 240px 320px; font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 52px; color: #ffd84d; letter-spacing: .2em; text-transform: uppercase; border-bottom: 2px solid #6ab6ff; padding-bottom: 16px; margin-bottom: 10px; }
.hs-bp-sched-row { display: grid; grid-template-columns: 240px 280px 1fr 240px 320px; padding: 18px 0; border-bottom: 1px dashed rgba(106,182,255,.3); align-items: center; }
.hs-bp-sched-row:last-child { border-bottom: 0; }
.hs-bp-t { font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 80px; color: #ffd84d; }
.hs-bp-c { font-family: 'JetBrains Mono', monospace; font-weight: 500; font-size: 60px; color: #6ab6ff; letter-spacing: .06em; }
.hs-bp-n { font-family: 'Archivo', sans-serif; font-weight: 700; font-size: 78px; color: #eaf3ff; letter-spacing: .02em; }
.hs-bp-r { font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 68px; color: #ffd84d; }
.hs-bp-w { font-family: 'Archivo', sans-serif; font-weight: 500; font-size: 60px; color: #6ab6ff; }
.hs-bp-specs { position: absolute; top: 1680px; left: 40px; right: 40px; height: 380px; display: grid; grid-template-columns: 1.1fr 1fr; gap: 28px; align-items: stretch; }
.hs-bp-card { border: 3px solid #6ab6ff; background: rgba(10,40,82,.45); padding: 32px 40px; position: relative; }
.hs-bp-card::before { content: attr(data-sheet); position: absolute; top: -22px; left: 36px; background: #0f3a7a; padding: 0 14px; font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 48px; color: #ffd84d; letter-spacing: .24em; }
.hs-bp-spec { display: grid; grid-template-columns: 280px 1fr; gap: 32px; align-items: start; }
.hs-bp-portrait { width: 280px; height: 320px; background: rgba(106,182,255,.12); border: 2px dashed #6ab6ff; position: relative; display: grid; place-items: center; }
.hs-bp-num { font-family: 'Archivo', sans-serif; font-weight: 900; font-size: 220px; color: #ffd84d; opacity: .4; line-height: .8; }
.hs-bp-h2 { font-family: 'Archivo', sans-serif; font-weight: 900; font-size: 110px; line-height: .9; color: #eaf3ff; margin: 6px 0 6px; letter-spacing: -.01em; }
.hs-bp-meta { font-family: 'JetBrains Mono', monospace; font-weight: 500; font-size: 56px; color: #6ab6ff; letter-spacing: .12em; text-transform: uppercase; margin-bottom: 18px; }
.hs-bp-quote { font-family: 'Archivo', sans-serif; font-style: italic; font-weight: 500; font-size: 78px; color: #eaf3ff; line-height: 1.2; border-left: 3px solid #ffd84d; padding-left: 24px; }
.hs-bp-alert-kicker { color: #ff6a5e; }
.hs-bp-alert-h3 { font-family: 'Archivo', sans-serif; font-weight: 900; font-size: 96px; line-height: .95; color: #ffd84d; margin: 10px 0 0; letter-spacing: -.01em; }
.hs-bp-alert-p { font-family: 'Archivo', sans-serif; font-weight: 500; font-size: 72px; color: #6ab6ff; line-height: 1.2; margin: 14px 0 0; }
.hs-bp-when { font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 52px; color: #ff6a5e; margin-top: 16px; letter-spacing: .16em; text-transform: uppercase; }
.hs-bp-ticker { position: absolute; bottom: 0; left: 0; right: 0; height: 100px; background: #ffd84d; color: #0a2852; display: flex; align-items: center; overflow: hidden; border-top: 3px solid #0a2852; }
.hs-bp-tk-tag { background: #0a2852; color: #ffd84d; height: 100%; display: flex; align-items: center; padding: 0 36px; font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 60px; letter-spacing: .24em; flex-shrink: 0; }
.hs-bp-tk-msg { font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 64px; white-space: nowrap; padding-left: 36px; letter-spacing: .14em; text-transform: uppercase; animation: hsBpScroll 55s linear infinite; display: inline-flex; }
