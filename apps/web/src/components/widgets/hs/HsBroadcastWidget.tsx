...
.hs-bc-sub { font-family: 'JetBrains Mono', monospace; font-weight: 500; font-size: 38px; letter-spacing: .24em; color: #8a93a6; text-transform: uppercase; }
...
.hs-bc-panel h3 { font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 40px; letter-spacing: .2em; text-transform: uppercase; color: #8a93a6; margin: 0 0 10px; }
...
.hs-bc-cap { font-family: 'Inter', sans-serif; font-weight: 600; font-size: 44px; color: #cbd5e1; margin-top: 8px; }
...
.hs-bc-mono { font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 38px; color: #0a0f1a; background: #fff; padding: 8px 14px; z-index: 1; position: relative; }
.hs-bc-guest-eyebrow { display: inline-block; font-family: 'Barlow Condensed', sans-serif; font-weight: 900; background: #0a0f1a; color: #fff; padding: 8px 22px; font-size: 44px; letter-spacing: .18em; text-transform: uppercase; }
...
.hs-bc-meta { font-family: 'JetBrains Mono', monospace; font-weight: 500; font-size: 42px; color: #475569; letter-spacing: .1em; text-transform: uppercase; }
.hs-bc-quote { font-family: 'Inter', sans-serif; font-weight: 500; font-size: 48px; color: #334155; margin-top: 20px; line-height: 1.25; font-style: italic; }
...
.hs-bc-tag { display: inline-block; font-family: 'Barlow Condensed', sans-serif; font-weight: 900; background: #ffd83d; color: #0a0f1a; padding: 10px 24px 12px; font-size: 48px; letter-spacing: .14em; text-transform: uppercase; }
...
.hs-bc-brk-p { font-family: 'Inter', sans-serif; font-weight: 500; font-size: 44px; color: #cbd5e1; margin: 0; line-height: 1.25; }
.hs-bc-date { font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 40px; color: #ffd83d; letter-spacing: .16em; margin-top: 22px; text-transform: uppercase; }
...
.hs-bc-when { font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 40px; color: #94a3b8; letter-spacing: .14em; text-transform: uppercase; }
.hs-bc-what { font-family: 'Barlow Condensed', sans-serif; font-weight: 900; font-size: 76px; line-height: .95; color: #fff; margin-top: 12px; text-transform: uppercase; }
...
.hs-bc-cd-lbl { font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 40px; letter-spacing: .2em; text-transform: uppercase; opacity: .9; }
