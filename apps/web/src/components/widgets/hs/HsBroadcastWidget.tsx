...
.hs-bc-sub { font-family: 'JetBrains Mono', monospace; font-weight: 500; font-size: 30px; letter-spacing: .24em; color: #8a93a6; text-transform: uppercase; }
...
.hs-bc-panel h3 { font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 30px; letter-spacing: .2em; text-transform: uppercase; color: #8a93a6; margin: 0 0 10px; }
...
.hs-bc-cap { font-family: 'Inter', sans-serif; font-weight: 600; font-size: 32px; color: #cbd5e1; margin-top: 6px; }
...
.hs-bc-mono { font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 30px; color: #0a0f1a; background: #fff; padding: 6px 12px; z-index: 1; position: relative; }
...
.hs-bc-meta { font-family: 'JetBrains Mono', monospace; font-weight: 500; font-size: 34px; color: #475569; letter-spacing: .1em; text-transform: uppercase; }
...
.hs-bc-date { font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 32px; color: #ffd83d; letter-spacing: .16em; margin-top: 20px; text-transform: uppercase; }
...
.hs-bc-when { font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 32px; color: #94a3b8; letter-spacing: .14em; text-transform: uppercase; }
...
.hs-bc-cd-lbl { font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 30px; letter-spacing: .2em; text-transform: uppercase; opacity: .9; }
