  ...
  return (
    <div style={frameStyle(r)}>
      ...
      <div style={{ position: 'absolute', left: '4%', top: '50%', transform: 'translateY(-50%)', animation: animOn ? `celFbTdShake ${shakeDur} ease-in-out 1` : undefined }}>
        <div style={{ fontSize: px(height, 0.62), lineHeight: 0.85, letterSpacing: '-0.04em', textShadow: `0 0 80px ${r.accent.highlight}, 0 8px 30px #000` }}>TOUCH</div>
        <div style={{ color: r.accent.primary, fontSize: px(height, 0.62), lineHeight: 0.85, letterSpacing: '-0.04em', textShadow: `0 0 80px ${r.accent.highlight}, 0 8px 30px #000`, marginTop: '2%' }}>DOWN!</div>
      </div>
  ...
  return (
    <div style={frameStyle(r)}>
      ...
      <div style={{ position: 'absolute', right: '4%', top: '50%', transform: 'translateY(-50%)', textAlign: 'right' }}>
        ...
        <div style={{ color: r.accent.primary, fontSize: px(height, 0.11), marginTop: '2%' }}>{sacks} SACKS THIS SEASON</div>
      </div>
    </div>
  );
}
  ...
  return (
    <div style={frameStyle(r)}>
      ...
      <div style={{ position: 'absolute', right: '4%', top: '50%', transform: 'translateY(-50%)', textAlign: 'right' }}>
        ...
        <div style={{ color: r.accent.primary, fontSize: px(height, 0.1), marginTop: '2%' }}>{count} INTs THIS SEASON</div>
      </div>
    </div>
  );
}
