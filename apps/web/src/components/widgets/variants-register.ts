...
const SPORT_ELEMENT_VARIANTS: Array<{
  ...
  { id: 'sb-team-record-home', name: 'Team Record · Home', description: 'Home W-L record (set in Properties).', render: TeamRecordWidget as any, defaultConfig: { team: 'home', fontSize: 32 } },
  { id: 'sb-team-record-away', name: 'Team Record · Away', description: 'Away W-L record.', render: TeamRecordWidget as any, defaultConfig: { team: 'away', fontSize: 32 } },
