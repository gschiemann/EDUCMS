...
function SunshineAcademyClock({ config, compact }: { config: any; compact: boolean }) {
...
function SunshineAcademyWeather({ config, compact }: { config: any; compact: boolean }) {
...
function SunshineAcademyCountdown({ config, compact }: { config: any; compact: boolean }) {
...
function SunshineAcademyText({ config }: { config: any }) {
...
function SunshineAcademyAnnouncement({ config, compact }: { config: any; compact: boolean }) {
...
function SunshineAcademyTicker({ config }: { config: any }) {
...
function SunshineAcademyCalendar({ config, compact }: { config: any; compact: boolean }) {
...
function SunshineAcademyStaffSpotlight({ config, compact }: { config: any; compact: boolean }) {
...
function SunshineAcademyImageCarousel({ config }: { config: any }) {
  return (
